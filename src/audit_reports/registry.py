...
REGISTRY: list[StatementType] = [
    ...
    StatementType("credit_quality", "Credit quality — closing balances (IFRS-9)",
    ...
    StatementType("loans_currency", "Loans by sector — currency split",
                  "bank_audit_loans_currency", None, "loans_currency", section="5",
                  is_core=False, present_min_rows=1, has_validator=True,
                  validation_statement="loans_currency", sort_order=75, annual_only=True),
    StatementType("risk_profile", "Pillar 3 risk profile by sector",
                  "bank_audit_risk_profile", None, "risk_profile", section="5",
                  is_core=False, present_min_rows=1, has_validator=True,
                  validation_statement="risk_profile", sort_order=76, annual_only=True),
    ...
    StatementType("fx_position", "FX net open position — summary (§4)",
    ...
    StatementType("repricing", "Interest-rate repricing gap — summary (§4)",
...
INFRA_TABLES: list[str] = ["bank_audit_validation", "bank_audit_extractions",
                           ...
                           # (data/bank_audit_capture.db, 11.2M cells) and never
