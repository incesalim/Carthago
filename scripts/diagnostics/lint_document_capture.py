...
Read-only against `data/bank_audit_capture.db`.
  ...
  python scripts/diagnostics/lint_document_capture.py --bank TSKB --period 2026Q1 --kind unconsolidated
  python scripts/diagnostics/lint_document_capture.py --all --summary
"""
