...
Usage:
  ...
  python scripts/diagnostics/extract_audit_text.py --pdf data/eye/AKBNK_2024Q1_unconsolidated.pdf \
      --out-dir build/audit_text

  # fleet, from R2 back to R2 (GitHub Actions)
  python scripts/diagnostics/extract_audit_text.py --workers 8
  python scripts/diagnostics/extract_audit_text.py --only-bank AKBNK,GARAN
