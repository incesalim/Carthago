...
(local only; never the audit snapshot, not D1).
  ...
  python scripts/graduations/build_lcr_full.py                      # fleet dry-run
  python scripts/graduations/build_lcr_full.py --bank AKBNK --period 2026Q1 --verbose
  python scripts/graduations/build_lcr_full.py --write
"""
