...
the derived-lane DB; nothing here reaches the audit snapshot or D1).
  ...
  python scripts/graduations/build_capital_full.py                    # fleet dry-run
  python scripts/graduations/build_capital_full.py --bank AKBNK --period 2026Q1 --verbose
  python scripts/graduations/build_capital_full.py --write
"""
