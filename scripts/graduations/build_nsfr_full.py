...
(local only; never the audit snapshot, not D1).
  ...
  python scripts/graduations/build_nsfr_full.py                      # fleet dry-run
  python scripts/graduations/build_nsfr_full.py --bank AKBNK --verbose
  python scripts/graduations/build_nsfr_full.py --write
"""
