...
| `/credit` | Total Loans level + YoY by group + 4w-ann. sector + bar by bank. TL / FX / FX share. Consumer mix stacked area (level + percent). Consumer segment YoY. SME YoY by group + SME-vs-Commercial YoY. Public-vs-Private YoY (total + TL). SME level. **Sourced from the weekly bulletin** (§10/§11; YoY = 52w, momentum = 4w-ann.); Retail-vs-Corporate cards + SME micro/small/medium mix stay monthly. | §4, §5, §8, §10, §11 |
| `/deposits` | Total deposits level, YoY by group, 4w-ann. sector, bar by bank. TL / FX / FX share. Demand level + share (demand summed from the three weekly depositor-type components). **From the weekly bulletin** (§10/§11); Maturity ladder (level + percent) and LDR by group stay monthly. | §4, §6, §7, §8, §10, §11 |
| `/asset-quality` | NPL by group + bar by bank. Coverage by group. Gross NPL stock (**real weekly-bulletin stock**, item 2.0.1 §10 — replaces the old total × ratio synthesis). Consumer NPL composition + per-product ratios. Commercial NPL (SME / commercial / non-SME from weekly bulletin). NPL ratio + coverage + consumer NPL stay monthly. | §4, §5, §7, §10 |
