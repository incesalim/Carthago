  ...
  return <div className="mb-5 border-t border-border pt-3 text-xs">
    ...
    {tables.map(table => {
      ...
      return <details className="mt-3 border-b border-border pb-3" key={table.review_id} open>
        ...
        {table.rows.some(r => r.reviewed_assignment) && <p className="mt-2 text-muted-foreground">Includes source-reviewed column assignments. The original physical cells remain available below and in the download.</p>}
