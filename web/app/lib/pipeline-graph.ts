...
export const PIPELINE_NODES: PipelineNode[] = [
  ...
  { id: "wf-document-related", kind: "workflow", layer: "ingestion", lane: "audit", label: "capture related audit documents", sublabel: "manual · other archive PDFs and recovered text; review pending", workflowFile: "capture-related-documents.yml" },
  { id: "wf-document-edition", kind: "workflow", layer: "ingestion", lane: "audit", label: "capture observed audit editions", sublabel: "manual · separate original, text and table candidates", workflowFile: "capture-document-edition.yml" },
...
export const PIPELINE_EDGES: PipelineEdge[] = [
  ...
  { source: "store-r2-pdf", target: "wf-document-origins" },
  { source: "wf-document-origins", target: "store-document-corpus" },
  { source: "store-document-corpus", target: "wf-document-related" },
  { source: "wf-document-related", target: "store-document-corpus" },
  { source: "store-document-corpus", target: "wf-document-edition" },
  { source: "wf-document-edition", target: "store-document-corpus" },
